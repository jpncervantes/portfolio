    ...
    return (
        <div className="ml-20 mr-20">
            <div className="hidden lg:flex flex-col">
                ...
                <div className="grid-cols-4 flex w-100 gap-0 2xl:h-[350px] xl:h-[250px] lg:h-[250px]">
                    <div className="border border-t-0 border-l-0 border-r-0 border-black w-[25%] flex xl:flex-row lg:flex-col mt-3 gap-2">
                    ...
                    <div className="border border-t-0 border-r-0 border-black w-[25%] flex flex-col justify-end pl-4 2xl:text-base xl:text-sm">
